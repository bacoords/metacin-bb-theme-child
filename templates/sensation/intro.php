<form method="post" action="<?php home_url( 'laboratory/sensation' ); ?>" class="met-sensation-intro">
	<input type="hidden" name="met_action" value="_met_sensation_viewed_intro">
	<input type="hidden" name="user_id" value="<?php echo esc_attr( get_current_user_id() ); ?>">
	<?php wp_nonce_field( '_met_sensation_viewed_intro', '_met_sensation_viewed_intro_nonce' ); ?>
	...
	<div id="met-sensation-intro-panel-2" class="met-sensation-intro-panel" style="display:none;">
		<h2>Participation:</h2>
	...
	<div id="met-sensation-intro-panel-3" class="met-sensation-intro-panel" style="display:none;">
		<h2>Appreciation:</h2>
		...
		<div class="form-group">
			<input type="checkbox" id="_met_sensation_viewed_intro" name="_met_sensation_viewed_intro" class="form-check" value="1" required />
			<label for="_met_sensation_viewed_intro">
	...
	<div class="met-sensation-intro-submit-container text-center" style="display:none">
		<button type="submit" class="btn btn-lg btn-sensation met-sensation-submit-btn" data-panel="1">Begin <i class="fas fa-play-circle"></i></button>
	</div>
